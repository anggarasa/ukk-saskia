...
<div class="bg-white rounded-lg shadow-sm overflow-hidden fade-in">
    ...
    <form action="<?= BASE_URL ?>/produk/store" method="post" class="px-6 py-5 space-y-6">
        ...
        <div class="flex justify-end space-x-3 border-t border-gray-200 pt-6">
            <a href="<?= BASE_URL ?>/produk" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                Batal
            </a>
